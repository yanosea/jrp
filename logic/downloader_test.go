	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(mockCtrl *gomock.Controller, tt *args) {
				...
				downloader := NewDBFileDownloader(OsEnv{}, OsUser{}, OSFileSystem{}, DefaultHttpClient{}, DefaultIO{}, DefaultGzip{})
			...
			setup: func(mockCtrl *gomock.Controller, tt *args) {
				...
				dbFilePath := filepath.Join(tcu.HomeDir, ".local", "share", "jrp")
				os.RemoveAll(dbFilePath)
				downloader := NewDBFileDownloader(OsEnv{}, mu, OSFileSystem{}, DefaultHttpClient{}, DefaultIO{}, DefaultGzip{})
				tt.downloader = downloader
			},
		}, {
			...
			setup: func(mockCtrl *gomock.Controller, tt *args) {
				...
				dbFilePath := filepath.Join(tcu.HomeDir, ".local", "share", "jrp")
				os.RemoveAll(dbFilePath)
				downloader := NewDBFileDownloader(OsEnv{}, OsUser{}, OSFileSystem{}, mhc, DefaultIO{}, DefaultGzip{})
				tt.downloader = downloader
			},
		}, {
			...
			setup: func(mockCtrl *gomock.Controller, tt *args) {
				...
				dbFilePath := filepath.Join(tcu.HomeDir, ".local", "share", "jrp")
				os.RemoveAll(dbFilePath)
				downloader := NewDBFileDownloader(OsEnv{}, OsUser{}, mfs, DefaultHttpClient{}, DefaultIO{}, DefaultGzip{})
				tt.downloader = downloader
			},
		}, {
			...
			setup: func(mockCtrl *gomock.Controller, tt *args) {
				...
				dbFilePath := filepath.Join(tcu.HomeDir, ".local", "share", "jrp")
				os.RemoveAll(dbFilePath)
				downloader := NewDBFileDownloader(OsEnv{}, OsUser{}, OSFileSystem{}, DefaultHttpClient{}, mio, DefaultGzip{})
				tt.downloader = downloader
			},
		}, {
			...
			setup: func(mockCtrl *gomock.Controller, tt *args) {
				...
				dbFilePath := filepath.Join(tcu.HomeDir, ".local", "share", "jrp")
				os.RemoveAll(dbFilePath)
				downloader := NewDBFileDownloader(OsEnv{}, OsUser{}, OSFileSystem{}, DefaultHttpClient{}, DefaultIO{}, mgz)
				tt.downloader = downloader
			},
		}, {
			...
			setup: func(mockCtrl *gomock.Controller, tt *args) {
				...
				dbFilePath := filepath.Join(tcu.HomeDir, ".local", "share", "jrp")
				os.RemoveAll(dbFilePath)
				downloader := NewDBFileDownloader(OsEnv{}, OsUser{}, mfs, mhc, mio, mgz)
				tt.downloader = downloader
			},
		}, {
