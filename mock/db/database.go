...
//
//	mockgen -source=internal/db/database.go -destination=mock/db/database.go -package=mock_db
//
...
func (m *MockDatabaseProvider) Query(db *sql.DB, query string) (*sql.Rows, error) {
	m.ctrl.T.Helper()
