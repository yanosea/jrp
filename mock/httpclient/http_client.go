...
// Source: internal/httpclient/http_client.go
//
// Generated by this command:
//
//	mockgen -source=internal/httpclient/http_client.go -destination=mock/httpclient/http_client.go -package=mock_httpclient
//
